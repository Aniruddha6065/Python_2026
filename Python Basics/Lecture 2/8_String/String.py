...
# Slicing in strings  & Slicing Negative Index
...
Stri="I am studying python from ASG"
print(Stri.endswith("SG"))

stri1="i am studying python from ASG"
stri1=stri1.capitalize()
print(stri1)

stri1="i am studying python from ASG"
stri1=stri1.replace("n","m")
print(stri1)
